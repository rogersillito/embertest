...
silent only
cd C:\DEV\embertest\app
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +1 router.js
badd +6 routes\application.js
badd +4 controllers\application.js
badd +1 controllers\application
badd +1 application.js
badd +1 templates\application.hbs
argglobal
silent! argdel *
argadd app.js
edit routes\application.js
...
exe 'vert 2resize ' . ((&columns * 75 + 70) / 140)
exe '3resize ' . ((&lines * 14 + 23) / 46)
exe 'vert 3resize ' . ((&columns * 64 + 70) / 140)
exe '4resize ' . ((&lines * 16 + 23) / 46)
argglobal
setlocal keymap=
setlocal noarabic
...
wincmd w
argglobal
edit controllers\application.js
setlocal keymap=
setlocal noarabic
setlocal noautoindent
setlocal backupcopy=
...
wincmd w
argglobal
edit templates\application.hbs
setlocal keymap=
setlocal noarabic
setlocal noautoindent
setlocal backupcopy=
